...
//        toggle.syncState();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).icon(BitmapDescriptorFactory.fromBitmap(
                CreateCustomMarker(MainActivity.this, R.drawable.ahmedk, "Ahmed K Madani"))));
